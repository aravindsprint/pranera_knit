import{_ as G,u as K,c as i,a as X,b as M,A as Z,d as t,w as tt,v as st,F as g,r as S,e as _,N as et,t as l,j as E,g as v,f as T,h as R,i as c,Q as lt}from"../index.js";const ot={class:"pl-page"},nt={class:"pl-content"},dt={class:"pl-card"},at={class:"pl-autocomplete"},it={key:0,class:"pl-dropdown"},ct=["onMousedown"],ut={key:0,class:"pl-check"},rt={key:0,class:"pl-chips"},pt=["onClick"],_t={class:"pl-actions"},ht=["disabled"],vt={key:0,class:"pl-spinner"},mt={key:1,class:"pl-error"},yt={key:0,class:"pl-kpi-row"},kt={class:"pl-kpi"},bt={class:"pl-kpi__num"},ft={class:"pl-kpi"},gt={class:"pl-kpi__num"},wt={class:"pl-kpi"},xt={class:"pl-kpi__num"},Ot={class:"pl-kpi"},$t={class:"pl-kpi__num"},St={class:"pl-kpi pl-kpi--loss"},Rt={class:"pl-kpi__num"},Wt={class:"pl-kpi__num"},qt={key:1,class:"pl-section"},Lt={class:"pl-section__hd"},Qt={class:"pl-section__count"},Et={class:"pl-table-wrap"},It={class:"pl-table"},Ft={class:"pl-td-num"},Ct={class:"pl-td-wo"},Tt={class:"pl-td-item"},Dt={class:"pl-td-num"},Pt={class:"pl-td-num"},Nt={class:"pl-td-num"},Ut={class:"pl-td-num"},Mt={class:"pl-td-num pl-loss"},At={class:"pl-td-num"},jt={class:"pl-tfoot"},zt={class:"pl-td-num"},Vt={class:"pl-td-num"},Bt={class:"pl-td-num"},Jt={class:"pl-td-num pl-loss"},Yt={class:"pl-td-num"},Ht={key:2,class:"pl-section"},Gt={class:"pl-section__hd"},Kt={class:"pl-section__count"},Xt={class:"pl-table-wrap"},Zt={class:"pl-table"},ts={class:"pl-td-num"},ss={class:"pl-td-wo"},es=["href"],ls={class:"pl-td-item"},os={class:"pl-td-num"},ns={class:"pl-td-num"},ds={key:3,class:"pl-section"},as={class:"pl-section__hd"},is={class:"pl-section__count"},cs={class:"pl-table-wrap"},us={class:"pl-table"},rs={class:"pl-td-num"},ps={class:"pl-td-wo"},_s=["href"],hs={class:"pl-td-item"},vs={class:"pl-td-num"},ms={class:"pl-td-num"},ys={key:4,class:"pl-section"},ks={class:"pl-section__hd"},bs={class:"pl-section__count"},fs={class:"pl-table-wrap"},gs={class:"pl-table"},ws={class:"pl-td-num"},xs={class:"pl-td-wo"},Os=["href"],$s={class:"pl-td-item"},Ss={class:"pl-td-num"},Rs={class:"pl-td-num"},Ws={__name:"ProcessLossPage",setup(qs){const D=K(),W=v(""),w=v([]),I=v(!1),r=v([]),q=v(!1),L=v(""),m=v([]),y=v([]),k=v([]),p=v([]),F=R(()=>p.value.length||m.value.length||y.value.length||k.value.length),x=R(()=>p.value.reduce((o,e)=>o+(e.sent_qty||0),0)),O=R(()=>p.value.reduce((o,e)=>o+(e.return_qty||0),0)),Q=R(()=>p.value.reduce((o,e)=>o+(e.received_qty||0),0)),$=R(()=>p.value.reduce((o,e)=>o+(e.process_loss_qty||0),0)),b=R(()=>{const o=x.value-O.value;return o>0?$.value/o*100:0});let P=null;function N(){I.value=!0,clearTimeout(P),P=setTimeout(async()=>{try{const o=await T("knit_process_loss_wo_search",{search:W.value||""});w.value=(o==null?void 0:o.message)||[]}catch{w.value=[]}},300)}function A(){setTimeout(()=>{I.value=!1},200)}function j(o){r.value.includes(o)||r.value.push(o),W.value="",w.value=[],I.value=!1}function z(o){r.value=r.value.filter(e=>e!==o)}function V(){r.value=[],W.value="",w.value=[],m.value=[],y.value=[],k.value=[],p.value=[],L.value=""}async function B(){if(r.value.length){q.value=!0,L.value="";try{const o=await T("knit_process_loss_details",{work_orders:JSON.stringify(r.value)}),e=(o==null?void 0:o.message)||{};m.value=e.sent||[],y.value=e.return||[],k.value=e.received||[];const s=await T("knit_process_loss_summary",{work_orders:JSON.stringify(r.value),sent:JSON.stringify(m.value),return_rows:JSON.stringify(y.value),received:JSON.stringify(k.value)});p.value=(s==null?void 0:s.message)||[]}catch(o){L.value=o.message||"Calculation failed.",console.error("Process loss error:",o)}finally{q.value=!1}}}function n(o){return o!=null?Number(o).toFixed(3):"–"}function U(o){return o>10?"pl-pct-badge--high":o>5?"pl-pct-badge--mid":"pl-pct-badge--low"}function J(o){return o>10?"pl-row--high":o>5?"pl-row--mid":""}function Y(){const o=r.value.join(", "),e=new Date().toLocaleDateString("en-IN"),s=[];s.push("PRANERA SERVICES AND SOLUTIONS PVT. LTD."),s.push("Process Loss Report"),s.push("Work Orders: "+o),s.push("Date: "+e),s.push(""),s.push("PROCESS LOSS SUMMARY"),s.push("#,Work Order,Item Code,UOM,WO Qty,Sent Qty,Return Qty,Received Qty,Loss Qty,Loss %"),p.value.forEach((a,f)=>{s.push([f+1,a.work_order,a.item_code,a.uom,n(a.wo_qty),n(a.sent_qty),n(a.return_qty),n(a.received_qty),n(a.process_loss_qty),n(a.process_loss_percentage)+"%"].join(","))}),s.push(["Totals","","","","",x.value.toFixed(3),O.value.toFixed(3),Q.value.toFixed(3),$.value.toFixed(3),b.value.toFixed(2)+"%"].join(",")),s.push(""),s.push("SENT DETAILS"),s.push("#,Work Order,Stock Entry,Item Code,WO Item,UOM,WO Qty,Sent Qty"),m.value.forEach((a,f)=>{s.push([f+1,a.work_order,a.stock_entry,a.item_code,a.wo_item_code,a.uom,n(a.wo_qty),n(a.sent_qty)].join(","))}),s.push(""),s.push("RETURN DETAILS"),s.push("#,Work Order,Stock Entry,Item Code,WO Item,UOM,WO Qty,Return Qty"),y.value.forEach((a,f)=>{s.push([f+1,a.work_order,a.stock_entry,a.item_code,a.wo_item_code,a.uom,n(a.wo_qty),n(a.return_qty)].join(","))}),s.push(""),s.push("RECEIVED DETAILS"),s.push("#,Work Order,Stock Entry,Item Code,UOM,WO Qty,Received Qty"),k.value.forEach((a,f)=>{s.push([f+1,a.work_order,a.stock_entry,a.item_code,a.uom,n(a.wo_qty),n(a.received_qty)].join(","))});const u=s.join(`
...
<div class="kpi-row">
  ...
  <div class="kpi"><b>${Q.value.toFixed(3)}</b><span>Total Received</span></div>
...
<div class="section">
  ...
  <table>
    ...
    <tfoot><tr>
      ...
      <td class="num">${Q.value.toFixed(3)}</td>
